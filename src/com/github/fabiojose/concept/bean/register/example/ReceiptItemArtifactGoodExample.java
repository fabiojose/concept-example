...
public final class ReceiptItemArtifactGoodExample implements IExample<ReceiptItem> {

	public static void main(String[] args) {
		
		final IExample<ReceiptItem> _example = new ReceiptItemArtifactGoodExample();
		_example.example();
	}
