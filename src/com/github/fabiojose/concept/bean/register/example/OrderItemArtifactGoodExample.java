...
public final class OrderItemArtifactGoodExample implements IExample<OrderItem>{

	public static void main(String[] args) {
		
		final IExample<OrderItem> _example = new OrderItemArtifactGoodExample();
		_example.example();
		
	}

	private IExample<ArtifactGood> good = new ArtifactGoodExample();
